...
def safety(): 
  ...
  if temp>40:
    if temp> 100 or (temp> 90 and hum_num>55):
    ...
    elif 40< temp<= 84 or (84 <= temp <90 and hum_num<60):
      ...
      dictionary['messagespanish'] = "Precaucion: debemos jugar fuera de solo 10 minutoss!!!"
  else:
    if temp< 10 or (10<=temp<= 20 and wind>5):
       dictionary['message'] = "TOO COLD DO NOT GO OUTSIDE!!!!"
       dictionary['image']="tocold.jpg" 
       dictionary['messagespanish'] = "Demasiado mucho frio! No conseguido fuera!!!!"
